...
public final class Metadata {
    ...
    public static final String NAME = "HotHMCL";
    public static final String FULL_NAME = "Hot of Hello Minecraft! Launcher";
    ...
    public static final String HELP_URL = null;
    public static final String CHANGELOG_URL = null;
    public static final String PUBLISH_URL = "https://github.com/Melon-Studio/Hot-HMCL";
    public static final String EULA_URL = "https://www.yuque.com/yanhuomili/zwuppi/kpabgeh7nlzlirul";

    public static final String BUILD_CHANNEL = "stable"; //stable(稳定版) or nightly(预览版) or dev(测试版)
